...
const Navbar = () => (
  ...
  const Presentation = ({ toggleBackgroundColor }) => (
  ...
  <section id="presentation" className="presentation-block">
    ...
    <p>Authenticité : Chaque projet est une aventure unique, et je m’investis pleinement pour dépasser vos attentes.</p>
    ...
    <p>Fiabilité : Freelance, je suis flexible et réactif pour répondre à vos besoins dans les meilleurs délais.</p>
  ...
  <section id="projects">
    ...
    <ul>
      <li>
        ...
        <h2>Site e-commerce full stack & accessible</h2>
      </li>
      <li>
      ...
      <li>
        ...
        <h2>Système solaire fait en HTML CSS</h2>
      </li>
      <li>
        <video width="320" height="240" controls>
  ...
  <section id="contact-form">
    ...
    <div className="social-links">
      ...
      <a href="https://github.com/ziadbouh" target="_blank" rel="noopener noreferrer">
        <img src="./image/github-logo-7880D80B8D-seeklogo.com.png" alt="GitHub" />
      </a>
    </div>
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <main>
        <Presentation toggleBackgroundColor={toggleBackgroundColor} />
        <Skills />
        <Projects />
      </main>
      <footer>
